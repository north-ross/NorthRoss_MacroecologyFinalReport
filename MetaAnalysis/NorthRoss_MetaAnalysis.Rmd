...
fg1 <-rma.mv(
  ...
  data=fgES)
summary(fg1)
# only significant change is in trees (shrubs are significant only at p=0.1)
# makes sense, trees should increase strongly with WT drawdown
...
fg2_plot <- orchaRd::mod_results(fg2, mod = "WTD_Difference", group = "PaperID",
                              by = "FG_Group")
